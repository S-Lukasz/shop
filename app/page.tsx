...
export default function Home() {
  ...
  const { isNavEnabled } = useContext(Context);
      ...
      return (
        <div className="fixed left-0 z-[5] flex h-full w-full flex-col bg-blue-100 px-8 pt-10 lg:relative lg:w-80">
          ...
          <button
            ...
            className="bold text-md mx-12 mt-10 flex w-32 rounded-lg bg-blue-500 px-4 py-1 text-center font-semibold text-white 
